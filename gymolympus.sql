...
CREATE TABLE LOCKER( 
ID_LOCKER               INT(4) AUTO_INCREMENT NOT NULL,
DISPONIBLE 				boolean    	NOT NULL,
PRIMARY KEY (ID_LOCKER));

CREATE TABLE LOCKERS_RENTADOS(
ID_RENTA INT ZEROFILL AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
(ID_CLIENTE,'Briceyda','Angeles','Perez',NULL,771152846,200,CURDATE(),'E');
 ...
 VALUES
 (ID_MEMBRECIA,1,'CN',CURDATE(),'2018/01/09','MENSUAL','200'),
 (ID_MEMBRECIA,2,'E',CURDATE(),'2018/01/09','MENSUAL','30'),
 (ID_MEMBRECIA,3,'CN',CURDATE(),'2018/01/09','VISITA','30'),
 (ID_MEMBRECIA,4,'CN',CURDATE(),'2018/01/09','VISITA','20'),
 (ID_MEMBRECIA,5,'E',CURDATE(),'2018/01/09','MENSUAL','180'),
 (ID_MEMBRECIA,6,'CN',CURDATE(),'2018/01/09','MENSUAL','200'),
 (ID_MEMBRECIA,7,'E',CURDATE(),'2018/01/09','MENSUAL','200'),
 (ID_MEMBRECIA,8,'CN',CURDATE(),'2018/01/13','VISITA','30'),
 (ID_MEMBRECIA,9,'CN',CURDATE(),'2018/01/02','VISITA','20'),
 (ID_MEMBRECIA,10,'CN',CURDATE(),'2018/01/13','VISITA','30'),
 (ID_MEMBRECIA,11,'CN',CURDATE(),'2018/01/09','VISITA','20'),
 (ID_MEMBRECIA,12,'E',CURDATE(),'2018/01/09','MENSUAL','180');
 
 INSERT INTO ASISTENCIA VALUES 
(ID_ASISTENCIA, 1, '2018/01/16',true),
(ID_ASISTENCIA, 1, '2018/01/15',true),
(ID_ASISTENCIA, 1, '2018/01/14',true),
(ID_ASISTENCIA, 1, '2018/01/13',true),
(ID_ASISTENCIA, 1, '2018/01/12',true),
(ID_ASISTENCIA, 1, '2018/01/11',true);
...
VALUES (ID_PAGO,'1','1',200,CURDATE()); 
 ...
 INSERT INTO LOCKERS_RENTADOS(ID_LOCKER, ID_CLIENTE, FECHA_RENTA, FECHA_FIN_RENTA, MONTO) VALUES 
(1, 1, '2018/01/05','2018/02/05', 100),
(2, 2, '2018/01/05','2018/02/05', 100),
(3, 3, '2018/01/05','2018/02/05', 100),
(4, 4, '2018/01/05','2018/02/05', 100),
(5, 5, '2018/01/05','2018/02/05', 100),
(6, 6, '2018/01/05','2018/02/05', 100);

CREATE OR REPLACE VIEW DETALLE_RENTA_LOCKER AS
SELECT LOCKERS_RENTADOS.ID_LOCKER AS ID_LOCKER, LOCKERS_RENTADOS.ID_CLIENTE AS ID_CLIENTE,
CLIENTE.NOMBRE AS NOMBRE, CLIENTE.APELLIDO_PA AS APELLIDO_PA, CLIENTE.APELLIDO_MA AS APELLIDO_MA,
LOCKERS_RENTADOS.FECHA_RENTA AS FECHA_RENTA, LOCKERS_RENTADOS.FECHA_FIN_RENTA AS FECHA_FIN_RENTA,
LOCKERS_RENTADOS.MONTO AS MONTO
FROM LOCKERS_RENTADOS
INNER JOIN CLIENTE ON LOCKERS_RENTADOS.ID_CLIENTE = CLIENTE.ID_CLIENTE; 
/*
